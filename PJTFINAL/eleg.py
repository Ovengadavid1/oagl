...
# Form implementation generated from reading ui file 'sommet.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.pushButton.setGeometry(QtCore.QRect(190, 270, 56, 17))
        self.pushButton.setObjectName("pushButton")
        self.label_2 = QtWidgets.QLabel(Form)
        self.label_2.setGeometry(QtCore.QRect(24, 80, 51, 20))
        ...
        self.label = QtWidgets.QLabel(Form)
        self.label.setGeometry(QtCore.QRect(170, 10, 151, 16))
        self.label.setStyleSheet("font: 14pt \"MS Reference Sans Serif\";")
        self.label.setObjectName("label")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_2.setText(_translate("Form", "Date emprunt"))
        self.label_3.setText(_translate("Form", "Nom"))
        self.label_4.setText(_translate("Form", "contact"))
        self.label.setText(_translate("Form", "Emprunt des livres"))
